...
export function Projects() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "radial-gradient(ellipse at 80% 50%, #0f0f2e 0%, transparent 55%)",
      }}
    >
      <div className="mx-auto max-w-7xl w-full grid md:grid-cols-[40%_60%] gap-10 items-center">
        ...
        <div className="relative">
          {/* purple ambient glow behind right cards */}
          <div
          ...
          <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {projects.map((p, i) => (
              ...
              >
                ...
                {/* default content */}
                <div className="relative h-full w-full transition-all duration-300 group-hover:blur-md group-hover:opacity-20">
                ...
                {/* hover overlay */}
                <div
                  className="absolute inset-0 rounded-2xl flex items-center justify-center gap-5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                  style={{
                ...
                >
                  {[
                    ...
                    >
                      <span
                        className="w-[52px] h-[52px] rounded-full flex items-center justify-center bg-white/10 border border-white/20 hover:bg-white/20 transition"
                      >
